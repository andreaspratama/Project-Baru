    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-body">
            ...
            <a href="" onclick="this.href='/guru/cekNilaiProsesKelasCek/'+ document.getElementById('kelas').value" class="btn btn-primary"><i class="fas fa-spinner mr-2"></i>Proses Nilai</a>
          </div>
        </div>
